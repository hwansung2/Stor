...
public class ProductCategoryVO {
	...
	public ProductCategoryVO(String category_name, String category_name_eng, String product_name,
			String product_name_eng, int product_number, int price, float rating) {
		super();
